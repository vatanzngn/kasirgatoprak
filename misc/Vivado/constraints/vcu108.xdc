...
# System clocks
# 300 MHz
 set_property -dict {LOC G31  IOSTANDARD DIFF_SSTL12} [get_ports sys_clk_i_p]
 set_property -dict {LOC F31  IOSTANDARD DIFF_SSTL12} [get_ports sys_clk_i_n]
...
#set_property -dict {LOC BC9  IOSTANDARD LVDS} [get_ports sys_clk_i_p]
#set_property -dict {LOC BC8  IOSTANDARD LVDS} [get_ports sys_clk_i_n]


# Reset button
# set_property -dict {LOC E36  IOSTANDARD LVCMOS12} [get_ports rst_ni]

# set_false_path -from [get_ports {rst_g}]
# set_input_delay 0 [get_ports {rst_g}]
...
## DIP switches
set_property -dict {LOC BC40 IOSTANDARD LVCMOS12} [get_ports {sys_rst_n}]
...
# PMOD0
#set_property -dict {LOC BC14 IOSTANDARD LVCMOS18 SLEW SLOW DRIVE 8} [get_ports {uart_tx_o}]
#set_property -dict {LOC BA10 IOSTANDARD LVCMOS18 SLEW SLOW DRIVE 8} [get_ports {program_rx_i}]
#set_property -dict {LOC AW16 IOSTANDARD LVCMOS18 SLEW SLOW DRIVE 8} [get_ports {spi_cs_o}]
#set_property -dict {LOC BB16 IOSTANDARD LVCMOS18 SLEW SLOW DRIVE 8} [get_ports {spi_sck_o}]
#set_property -dict {LOC BC13 IOSTANDARD LVCMOS18 SLEW SLOW DRIVE 8} [get_ports {spi_mosi_o}]
#set_property -dict {LOC BF7  IOSTANDARD LVCMOS18 SLEW SLOW DRIVE 8} [get_ports {spi_miso_i}]
#set_property -dict {LOC AW12 IOSTANDARD LVCMOS18 SLEW SLOW DRIVE 8} [get_ports {program_rx_i}]
...
# PMOD1
# set_property -dict {LOC P22  IOSTANDARD LVCMOS12 SLEW SLOW DRIVE 8} [get_ports {clk_on}]
# set_property -dict {LOC N22  IOSTANDARD LVCMOS12 SLEW SLOW DRIVE 8} [get_ports {clk_op}]
# set_property -dict {LOC J20  IOSTANDARD LVCMOS12 SLEW SLOW DRIVE 8} [get_ports {clk_oi}]
...
# UART
set_property -dict {LOC BE24 IOSTANDARD LVCMOS18 SLEW SLOW DRIVE 8} [get_ports RsTx]
set_property -dict {LOC BC24 IOSTANDARD LVCMOS18} [get_ports RsRx]
